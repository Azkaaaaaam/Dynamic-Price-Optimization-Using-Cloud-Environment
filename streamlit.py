...
with col2:
      st.markdown('<iframe src="https://data.cityofnewyork.us/w/d3c5-ddgc/25te-f2tw?cur=cLNQRsEjlFe&from=root" width="620" height="400" frameborder="0" scrolling="no"></iframe>', unsafe_allow_html=True)
